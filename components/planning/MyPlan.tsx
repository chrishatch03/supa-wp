          ...
          {editUserProfile && (
            <>
              <nav
                id="navBar"
                className={`z-10 ${
                  editUserProfile ? "" : "hidden"
                } absolute top-0 left-0 w-1/4 flex justify-center h-full backdrop-blur-md`}
              >
                <div className="w-full flex flex-col h-full justify-start ">
                  <div className="flex flex-col justify-center w-full max-w-4xl p-3 text-sm h-28 mt-1 border-b border-b-primary dark:border-b-white">
                    <div className="flex flex-row justify-start w-full h-full max-h-10">
                      <button
                        onClick={() => setEditUserProfile(!editUserProfile)}
                        className="ml-2 w-auto  flex justify-center items-center p-3 text-sm rounded-md no-underline bg-transparent"
                      >
                        <Avatar />
                      </button>
                    </div>
                  ...
                  {user ? (
                    <div className="w-full h-full p-3 flex flex-col items-center gap-2">
                      ...
                      <button
                        ...
                        className="w-full py-2 px-4 rounded-md no-underline bg-primary dark:bg-white text-white dark:text-primary hover:bg-btn-background-hover"
                      >
                        Choose Avatar
                      </button>
                      {editAvatar && (
                        <div className="flex flex-col items-center justify-center mt-4 max-w-lg">
                          ...
                          <div className="flex flex-col items-center justify-center gap-2">
                            <div
                              className="p-4 border-2 border-dashed border-gray-300 rounded-md flex flex-col items-center justify-center"
                              onDrop={handleDrop}
                            ...
                            <div className="w-full flex flex-row justify-center items-center">
                              <button onClick={handleChooseAvatar} className="p-2 bg-primary dark:bg-white text-white dark:text-primary hover:bg-btn-background-hover rounded-md">
                                Upload Avatar
                              </button>
                            </div>
                          </div>
